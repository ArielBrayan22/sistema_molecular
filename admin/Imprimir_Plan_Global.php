 ...
 if(isset($_POST['BtnImprimir_PG'])){
  require("coneccion.php");
  echo $Cod_M=$_POST['txt_ID_Materia']; 

  $sql="SELECT * FROM planglobal WHERE ID_Materia='$Cod_M'";
  $resultado=mysql_query($sql);

  while($row=mysql_fetch_array($resultado))
  {
      echo $Cod_PG=$row['ID_PG'];
  }
  ...
  # Cargamos la librería dompdf.
   ...
   //MOSTRAR SELECCION Y ORGANIZACION DE CONTENIDOS
           ...
           for ($i=0; $i <$u; $i++) { 
               ...
               $html.='<tr><td>Objetivo(s) de la unidad:</td></tr>';
                ...
                for ($j=0; $j <$n ; $j++) { 
                    ...
                    $resultado3=mysql_query($query3,$link);
                     ...
                     $html.='<tr><td>&nbsp;&bull; '.mysql_result($resultado3, $j, "Objetivo").'</td></tr>';
